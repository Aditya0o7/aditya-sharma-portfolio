...
const experiences = [
  {
    ...
    date: "Sep 2024",
    description: "Simulated investment banking project with hands-on data modeling, scenario analysis, and risk assessment",
    highlights: [
  ...
  },
  {
    ...
    date: "Aug 2024",
    description: "Ranked 12th out of 100+ teams, built scalable prototype in 36 hours",
    highlights: [
            ...
            {allItems.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Highlights */}
                  {item.type === "experience" && (item as any).highlights && (
